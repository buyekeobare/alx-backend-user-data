...
def filter_datum(fields: List[str], redaction: str,
    ...
    Args:
        ...
        redaction: value to use for redaction
        message: string message to filter
        separator: separator to use between fields

    Returns:
        Filtered string message with redacted values
    """
    for f in fields:
...
def get_logger() -> logging.Logger:
    """
    Return a Logger object for handling Personal Data
...
def get_db() -> mysql.connector.connection.MySQLConnection:
    """
    Return a MySQLConnection object for accessing Personal Data database
